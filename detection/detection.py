...
def read_image(image):
    ...
    eye = eye_detection.detectMultiScale(outImg, scaleFactor=1.3, minNeighbors=6)
    
    #make it possible for multiple eyes
    eyeImage1 = outImg[eye[0][1]:eye[0][1]+eye[0][3], eye[0][0]:eye[0][0]+eye[0][2]]
    eyeImage2 = outImg[eye[1][1]:eye[1][1]+eye[1][3], eye[1][0]:eye[1][0]+eye[1][2]]
    ...
    cv.rectangle(outImg,tuple1,tuple2,(255, 0, 0),2)
    cv.rectangle(outImg,tuple3,tuple4,(0, 255, 0),2)

    cv.imwrite("testingpics.jpg", outImg)

    

filename = "testingpic.jpg"
